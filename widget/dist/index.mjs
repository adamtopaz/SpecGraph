...
var src_default = (props) => {
  ...
  const gx = useRef();
  const gy = useRef();
  const x2 = linear2([0, data.length - 1], [5, 120 - 5]);
  const y2 = linear2(extent(data), [120 - 5, 5]);
  const line = line_default((d, i) => x2(i), y2);
  useEffect(() => void select_default2(gx.current).call(axisBottom(x2)), [gx, x2]);
  useEffect(() => void select_default2(gy.current).call(axisLeft(y2)), [gy, y2]);
  return /* @__PURE__ */ jsxs("svg", { width: 120, height: 120, children: [
    /* @__PURE__ */ jsx("g", { ref: gx, transform: `translate(0,${120 - 5})` }),
    /* @__PURE__ */ jsx("g", { ref: gy, transform: `translate(${5},0)` }),
    /* @__PURE__ */ jsx("path", { fill: "none", stroke: "currentColor", strokeWidth: "1.5", d: line(data) }),
    /* @__PURE__ */ jsx("g", { fill: "white", stroke: "currentColor", strokeWidth: "1.5", children: data.map((d, i) => /* @__PURE__ */ jsx("circle", { cx: x2(i), cy: y2(d), r: "2.5" }, i)) })
  ] });
};
export {
