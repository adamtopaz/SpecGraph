...
var w = function(n2, a2, i2) {
  ...
  for (var d2 = 1 << u2, p2 = d2, w2 = -1, y2 = -1, f2 = -1, h2 = d2, _2 = new r(512 + (d2 << 2)), m2 = new o(_2, 0, 256), v2 = new t(_2, 0, 256), B2 = new t(_2, 512, d2), D2 = 512 + (d2 << 1), E2 = new e(_2, D2, d2), M2 = new e(_2, D2 + d2); w2 < 255 && p2 > 0; ) {
    var R2 = l(p2 + 1), F2 = s2 >> 3, b2 = (1 << R2 + 1) - 1, L2 = (n2[F2] | n2[F2 + 1] << 8 | n2[F2 + 2] << 16) >> (7 & s2) & b2, G2 = (1 << R2) - 1, O2 = b2 - p2 - 1, Y3 = L2 & G2;
    if (Y3 < O2 ? (s2 += R2, L2 = Y3) : (s2 += R2 + 1, L2 > G2 && (L2 -= O2)), m2[++w2] = --L2, -1 == L2 ? (p2 += L2, E2[--h2] = w2) : p2 -= L2, !L2)
      do {
        var X3 = s2 >> 3;
        y2 = (n2[X3] | n2[X3 + 1] << 8) >> (7 & s2) & 3, s2 += 2, w2 += y2;
      } while (3 == y2);
  }
  (w2 > 255 || p2) && c(0);
...
var R = function(r2, o2, n2) {
  ...
  if (!(R2 > r2.length)) {
    ...
    if (2 == p2) {
      var F2 = r2[u2], b2 = 3 & F2, L2 = F2 >> 2 & 3, G2 = F2 >> 4, O2 = 0, Y3 = 0;
      b2 < 2 ? 1 & L2 ? G2 |= r2[++u2] << 4 | (2 & L2 && r2[++u2] << 12) : G2 = F2 >> 3 : (Y3 = L2, L2 < 2 ? (G2 |= (63 & r2[++u2]) << 4, O2 = r2[u2] >> 6 | r2[++u2] << 2) : 2 == L2 ? (G2 |= r2[++u2] << 4 | (3 & r2[++u2]) << 12, O2 = r2[u2] >> 2 | r2[++u2] << 6) : (G2 |= r2[++u2] << 4 | (63 & r2[++u2]) << 12, O2 = r2[u2] >> 6 | r2[++u2] << 2 | r2[++u2] << 10)), ++u2;
      var X3 = n2 ? n2.subarray(o2.y, o2.y + o2.m) : new e(o2.m), x2 = X3.length - G2;
      if (0 == b2)
        X3.set(r2.subarray(u2, u2 += G2), x2);
      else if (1 == b2)
        i(X3, r2[u2++], x2);
      else {
        var j = o2.h;
        if (2 == b2) {
          var S = function(r3, o3) {
            ...
            var L3 = 0;
            for (n3 = 0; n3 < a2; ++n3)
              (X4 = d3[n3]) > 11 && c(0), L3 += X4 && 1 << X4 - 1;
            var G3 = l(L3) + 1, O3 = 1 << G3, Y4 = O3 - L3;
            for (Y4 & Y4 - 1 && c(0), d3[a2++] = l(Y4) + 1, n3 = 0; n3 < a2; ++n3) {
              var X4 = d3[n3];
              ++p3[d3[n3] = X4 && G3 + 1 - X4];
            }
          ...
          j || c(0);
        (Y3 ? M : E)(r2.subarray(u2, u2 += O2), X3.subarray(x2), j);
      }
      var U = r2[u2++];
      if (U) {
...
var G = ("undefined" != typeof document && document.currentScript?.src, function(r2 = {}) {
  ...
  var G2, O2, Y3, X3 = (r3) => r3.startsWith("data:application/octet-stream;base64,"), x2 = (r3) => r3.startsWith("file://");
  function j(r3) {
    if (r3 == G2 && o2)
  ...
  var I = { ttys: [], init() {
    ...
    var o3 = r3(e3);
    y2[t3 >> 2] = o3.dev, y2[t3 + 4 >> 2] = o3.mode, f2[t3 + 8 >> 2] = o3.nlink, y2[t3 + 12 >> 2] = o3.uid, y2[t3 + 16 >> 2] = o3.gid, y2[t3 + 20 >> 2] = o3.rdev, Y3 = [o3.size >>> 0, (O2 = o3.size, +Math.abs(O2) >= 1 ? O2 > 0 ? +Math.floor(O2 / 4294967296) >>> 0 : ~~+Math.ceil((O2 - +(~~O2 >>> 0)) / 4294967296) >>> 0 : 0)], y2[t3 + 24 >> 2] = Y3[0], y2[t3 + 28 >> 2] = Y3[1], y2[t3 + 32 >> 2] = 4096, y2[t3 + 36 >> 2] = o3.blocks;
    var n3 = o3.atime.getTime(), a3 = o3.mtime.getTime(), i3 = o3.ctime.getTime();
    return Y3 = [Math.floor(n3 / 1e3) >>> 0, (O2 = Math.floor(n3 / 1e3), +Math.abs(O2) >= 1 ? O2 > 0 ? +Math.floor(O2 / 4294967296) >>> 0 : ~~+Math.ceil((O2 - +(~~O2 >>> 0)) / 4294967296) >>> 0 : 0)], y2[t3 + 40 >> 2] = Y3[0], y2[t3 + 44 >> 2] = Y3[1], f2[t3 + 48 >> 2] = n3 % 1e3 * 1e3, Y3 = [Math.floor(a3 / 1e3) >>> 0, (O2 = Math.floor(a3 / 1e3), +Math.abs(O2) >= 1 ? O2 > 0 ? +Math.floor(O2 / 4294967296) >>> 0 : ~~+Math.ceil((O2 - +(~~O2 >>> 0)) / 4294967296) >>> 0 : 0)], y2[t3 + 56 >> 2] = Y3[0], y2[t3 + 60 >> 2] = Y3[1], f2[t3 + 64 >> 2] = a3 % 1e3 * 1e3, Y3 = [Math.floor(i3 / 1e3) >>> 0, (O2 = Math.floor(i3 / 1e3), +Math.abs(O2) >= 1 ? O2 > 0 ? +Math.floor(O2 / 4294967296) >>> 0 : ~~+Math.ceil((O2 - +(~~O2 >>> 0)) / 4294967296) >>> 0 : 0)], y2[t3 + 72 >> 2] = Y3[0], y2[t3 + 76 >> 2] = Y3[1], f2[t3 + 80 >> 2] = i3 % 1e3 * 1e3, Y3 = [o3.ino >>> 0, (O2 = o3.ino, +Math.abs(O2) >= 1 ? O2 > 0 ? +Math.floor(O2 / 4294967296) >>> 0 : ~~+Math.ceil((O2 - +(~~O2 >>> 0)) / 4294967296) >>> 0 : 0)], y2[t3 + 88 >> 2] = Y3[0], y2[t3 + 92 >> 2] = Y3[1], 0;
  ...
  var hr = { b: (r3, e3, t3) => {
    ...
    try {
      ...
      return rr.llseek(i3, a3, o3), Y3 = [i3.position >>> 0, (O2 = i3.position, +Math.abs(O2) >= 1 ? O2 > 0 ? +Math.floor(O2 / 4294967296) >>> 0 : ~~+Math.ceil((O2 - +(~~O2 >>> 0)) / 4294967296) >>> 0 : 0)], y2[n3 >> 2] = Y3[0], y2[n3 + 4 >> 2] = Y3[1], i3.getdents && 0 === a3 && 0 === o3 && (i3.getdents = null), 0;
    } catch (r4) {
      if (void 0 === rr || "ErrnoError" !== r4.name)
        throw r4;
      return r4.errno;
    ...
    return F2(), (r3 = o2, e3 = G2, a3 = s3, i3 = function(r4) {
      u3(r4.instance);
    }, r3 || "function" != typeof WebAssembly.instantiateStreaming || X3(e3) || x2(e3) || "function" != typeof fetch ? S(e3, a3, i3) : fetch(e3, { credentials: "same-origin" }).then((r4) => WebAssembly.instantiateStreaming(r4, a3).then(i3, function(r5) {
  ...
  layout(r2, e2 = "svg", t2 = "dot", o2) {
    ...
    try {
      !function(r3, e3) {
        ...
        var o3;
        [...t3.files, ...(o3 = t3.images, o3.map(X2))].forEach((e4) => r3.createFile(e4.path, e4.data));
      }(n2, o2);
      try {
...
function mkDot({ nodes, edges }) {
  var out = "digraph {\n";
  nodes.forEach(
    (e2) => out += `  ${e2.id} [label="${e2.name}", id=${e2.id}];
`
  );
  edges.forEach(
    (e2) => out += `  ${e2.source} -> ${e2.target};
`
  );
  return out + "\n}";
}
function mkGraph({ nodes, edges }) {
  ...
  useEffect(() => {
    graphviz("#graph", { ...defaultOptions, zoom: true }).renderDot(mkDot({ nodes, edges })).on("end", () => {
      selectAll_default2("#graph g.node").each(function() {
        const gNode = select_default2(this);
        gNode.attr("pointer-events", "fill");
        gNode.on("click", function(event) {
          event.stopPropagation();
          const nodeId = select_default2(this).attr("id");
